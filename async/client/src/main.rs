...
async fn use_all_server() {
    let f1 = async_use_server("127.0.0.1", 8080, "use server-foo download 127.0.0.1:8080");
    let f2 = async_use_server("127.0.0.1", 8081, "use server-bar download 127.0.0.1:8081");
    join!(f1, f2);
}
